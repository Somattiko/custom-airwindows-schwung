...
The Move runs glibc 2.35 and GLIBCXX up to 3.4.29. Plugins built on newer systems may fail to load. See BUILDING.md for details on building compatible plugins.
